      ...
      <v-card>
        ...
        <v-row>
          <v-container>
            <br>
            &emsp;&emsp;
            <v-btn size="30%" v-if="this.data.status == !'verified' || this.data.status==!'rejected'" text outlined  color="indigo darken-4" style="color:white;" @click="approve(data.email, data.hse_regno, ndata.name)">Approve</v-btn>&emsp;
            <v-btn size="30%" v-if="this.data.status == !'verified' || this.data.status==!'rejected'" text outlined  color="indigo darken-4" style="color:white;" @click="deny(data.email, data.hse_regno, ndata.name)">Reject</v-btn>&emsp;
