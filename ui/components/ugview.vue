    ...
    <v-card>
      ...
      <v-row>
        ...
        <v-container>
          ...
          &emsp;&emsp;
          <v-btn text outlined  color="indigo darken-4" style="color:white;" @click="approve(data.email, data.ug_regno, ndata.name)">Approve</v-btn>&emsp;
          <v-btn text outlined  color="indigo darken-4" style="color:white;" @click="deny(data.email, data.ug_regno, ndata.name)">Reject</v-btn>&emsp;
